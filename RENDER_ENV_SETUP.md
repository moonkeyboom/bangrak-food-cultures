...
- ✅ **MUST use Direct Connection**: `lzuxhsqrmgorczmyynqa.supabase.co:5432` (NO "db." prefix!)
...
2. **Verify SPRING_DATASOURCE_URL** uses Direct Connection (lzuxhsqrmgorczmyynqa.supabase.co:5432 - NO "db." prefix!)
